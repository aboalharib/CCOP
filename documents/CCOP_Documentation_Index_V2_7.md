...
CCOP_Database_Design_Draft_V1.md

CCOP_Development_Prompt_Framework_V1.md

CCOP_Hybrid_Platform_Architecture_Pattern_V1.md

Purpose:

Defines the operating environment, system structure, monitoring architecture, telemetry platform, calibration architecture, data governance architecture, simulation framework, technology stack, backend platform architecture, database design, AI-assisted development prompts, and the hybrid platform pattern that combines telemetry, climate intelligence, geospatial operations, and workflow support.
...
CCOP_TerraNode_System_Specification_V1.md
...
Defines the hardware and operational specifications of CCOP monitoring devices.

13 Recommended Reading Order

CCOP_Documentation_Index_V2_7.md
...
2.7	Added CCOP Hybrid Platform Architecture Pattern and updated architecture documentation structure
