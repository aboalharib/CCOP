...
- the relationship between monitoring stations, communication infrastructure, and the centralized platform  
...
- factory calibration  
- comparison with TerraNode reference monitoring stations  
- algorithmic calibration models applied within the CCOP platform  

These processes support environmental data consistency across the monitoring network.

---

# 8 Environmental Data Governance Context

Environmental telemetry collected by the monitoring network is subject to environmental data governance processes.
...
Environmental data governance processes support the reliability of environmental information generated by the system.

---

# 9 Communication Infrastructure

Monitoring stations transmit telemetry through available communication infrastructure including:
...
# 11 Environmental Reporting Context
...
| 2.4 | Added environmental data governance context |
